...
microscopes_hmm_lib, microscopes_hmm_inc = find_dependency(
    'libmicroscopes_hmm.{}'.format(so_ext), 'microscopes')

join = os.path.join
dirname = os.path.dirname
basedir = join(dirname(__file__), 'microscopes', 'hmm')
...
if microscopes_hmm_inc is not None:
    print 'Using microscopes_hmm_inc:', microscopes_hmm_inc
if microscopes_hmm_lib is not None:
    print 'Using microscopes_hmm_lib:', microscopes_hmm_lib
if cc is not None:
...
if microscopes_hmm_inc is not None:
    include_dirs.append(microscopes_hmm_inc)
...
if microscopes_hmm_lib is not None:
    library_dirs.append(microscopes_hmm_lib)
...
def make_extension(module_name):
    ...
    return Extension(
        ...
        libraries=["microscopes_common", "microscopes_hmm",
...
setup(version=version,
      name='microscopes-hmm',
      description='Non-parametric bayesian inference',
      long_description=long_description,
      url='https://github.com/datamicroscopes/hmm',
      author='David Pfau, Stephen Tu, Eric Jonas',
      maintainer='David Pfau',
      maintainer_email='david.pfau@gmail.com',
      packages=(
          'microscopes.hmm',
      ),
